    ...
    <div class="firstsection">
        <div class="box">
            <div class="firstHalf">
                ...
                <p class="text-small">
                    WerBorsa ltd.sti'ye bağlı olan internetten borsaya ulaşmanın en kısa yolu WerBorsa.com'a hoşgeldiniz.
                    WerBorsa’da güncel borsa bilgileri yer alır ya da başka bir anlamda fiyatlar canlı bir şekilde sunulur.
                </p>
            </div>
        </div>
    </div>
