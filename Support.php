...
<div class="SupportForm">
    <form action="support-process.php" method="post">
        <h1 style="color:white">Destek Formu</h1>

        <label for="name">Adınız</label>
        <input type="text" id="name" name="name" placeholder="Adınızı giriniz..">

        <label for="surname">Soyadınız</label>
        <input type="text" id="surname" name="surname" placeholder="Soyadınızı giriniz..">
        ...
        <label for="message">Yaşadığınız sorunu aşağıya yazınız</label>
